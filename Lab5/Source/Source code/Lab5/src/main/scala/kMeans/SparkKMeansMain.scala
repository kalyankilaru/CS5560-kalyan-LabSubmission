...
object SparkKMeansMain {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val inputPath="E:\\UMKC\\Sum_May\\KDM\\Week 5\\Yahoo-Question-testdata.csv"
  ...
  /**
    ...
    */
  private def preprocess(sc: SparkContext,paths: String): (RDD[(Long, Vector)], RDD[(String,String)], Long) = {
