...
object SparkRandomForest {
  ...
  private def run(params: Params) {*/
    ...
    val topic_output = new PrintStream("data/random_Results.txt")
    ...
    val model = RandomForest.trainClassifier(training, numClasses+1, categoricalFeaturesInfo, numTrees, featureSubSet, impurity, maxDepth, maxDepth)
